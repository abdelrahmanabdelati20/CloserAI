      ...
      <aside className="w-64 bg-white border-r flex flex-col">
        <div className="p-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-brand-900">CloserAI</span>
          </div>
        </div>
        ...
        <div className="p-4 border-t">
          <div className="text-sm text-gray-500 mb-2 px-4">{session?.user?.name}</div>
          <button
            onClick={() => signOut({ callbackUrl: "/" })}
            className="w-full flex items-center gap-3 px-4 py-2 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition text-sm"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
